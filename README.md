...
Auth: JWT (manual or via NextAuth)
UI: Tailwind CSS + Headless UI or Flowbite
...
Middleware: verifyToken for protected API routes
...
Frontend: Display page numbers, next/prev buttons
Testing
